...
#| fig-cap: "Distribution of log stem diameter and log height across growth forms."
analysis_df %>%
  tidyr::pivot_longer(
...
@fig-violin-plots shows distribution of log stem diameter and log height across growth forms.
...
## Modelling overall `stem_diameter` as a function of `height` with a `growth_form` interaction term

Then we fit a linear model of form `log(stem_diameter)` as a function of `log(height)` adding a `growth_form` interaction
...
```{r}
#| echo: false
#| tbl-cap: "Growth interaction model evaluation"
...
```{r}
#| echo: false
#| tbl-cap: "Growth interaction model coefficients"
...
```{r}
#| echo: false
#| fig-cap: "Relationship between stem diameter and height between different growth forms"
#| label: fig-growth-lm
analysis_df %>%
...
See @fig-growth-lm, @tbl-growth-glance and @tbl-growth-tidy for results.

#Summary

Our results agree with the results in the literature [@Haase; @THORNLEY1999195; @CANNELL1984299].
